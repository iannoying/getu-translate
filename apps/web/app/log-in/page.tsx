...
export default function LogInPage() {
  ...
  return (
    <SiteShell>
      <PageHero eyebrow="Account" title={mode === "signin" ? "Sign in" : "Create account"}>
        <p>{mode === "signin" ? "Welcome back to GetU Translate." : "Get started with GetU Translate."}</p>
      </PageHero>
      ...
      <section className="auth-card-wrap">
        <div className="auth-card">
          ...
          <div className="auth-social">
            <p className="auth-divider-label">Continue with</p>
            <div className="auth-social-btns">
              <button
                ...
                title={providers.google ? "Continue with Google" : "Google — coming soon"}
              >
                <GoogleIcon />
                {providers.google ? "Google" : "Google (coming soon)"}
              </button>
              <button
                className="button secondary auth-social-btn"
                disabled={!providers.github || loading}
                onClick={() => providers.github && handleSocial("github")}
                title={providers.github ? "Continue with GitHub" : "GitHub — coming soon"}
              >
                <GitHubIcon />
                {providers.github ? "GitHub" : "GitHub (coming soon)"}
              </button>
            </div>
          </div>
