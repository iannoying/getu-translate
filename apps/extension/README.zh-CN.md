...
[English](./README.md) · **简体中文** · [官方网站](https://getutranslate.com) · [教程](https://www.getutranslate.com/zh/tutorial) · [更新日志](https://www.getutranslate.com/zh/changelog) · [博客](https://www.getutranslate.com/zh/blog)
...
> 本扩展 fork 自 [mengxi-ream/read-frog](https://github.com/mengxi-ream/read-frog)，以 **GetU Translate（懂你翻译）** 为名在 GPL-3.0 协议下独立维护。原项目仍为上游源。
...
<div align="center">
  <img src="assets/node-translation-demo.gif" width="38%" alt="GetU Translate 弹窗界面" />
  <img src="assets/page-translation-demo.gif" width="60%" alt="GetU Translate 翻译界面" />
</div>

## 👋🏻 快速开始 & 加入我们的社区

GetU Translate 的愿景是为各个级别的语言学习者提供易于使用、智能化和个性化的语言学习体验。这在 AI 时代已成为可能，但市场上很少有产品满足这一需求。因此，我们决定自己动手，最终让世界不再依赖人类语言教师。

无论您是用户还是开发者，GetU Translate 都将是您实现这一愿景的方式。请注意，GetU Translate 目前正在积极开发中，欢迎对遇到的任何[问题][issues-link]提供反馈。
...
借助 GetU Translate 的强大功能，将您的日常网页阅读转变为沉浸式语言学习之旅。
...
让 AI 理解您正在阅读内容的完整上下文。启用后，GetU Translate 使用 Mozilla 的 Readability 库提取文章的标题和内容，将此上下文提供给 AI，以获得更准确、更符合语境的翻译。
...
通过智能请求批处理节省高达 70% 的 API 成本。GetU Translate 将多个翻译请求合并为单次 API 调用，在保持翻译质量的同时减少开销和令牌使用。
...
一键深度文章分析。GetU Translate 使用 Mozilla 的 Readability 提取主要内容，检测源语言，并用您的目标语言生成摘要和导读。
...
查看[贡献指南](https://getutranslate.com/zh/tutorial/code-contribution/contribution-guide)了解更多详情。

GetU Translate 采用 GPLv3 和商业许可双重授权。
...
[docs-tutorial]: https://getutranslate.com/zh/tutorial
