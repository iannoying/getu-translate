...
interface ProtocolMap {
  ...
  executeTranslationWorkbenchRequest: (data: { text: string, langConfig: Config["language"], providerConfig: ProviderConfig, headers?: Record<string, string | undefined> }) => Promise<string>
